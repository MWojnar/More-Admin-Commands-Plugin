    ...
    public class MoreAdminCommands : TerrariaPlugin
    {
        ...
        public static void ClearItems(CommandArgs args) {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                if ((distance(new Microsoft.Xna.Framework.Vector2(Main.item[i].position.X, Main.item[i].position.Y), new Point((int)args.Player.X, (int)args.Player.Y)) < radius * 16) && (Main.item[i].active))
                {
        ...
        public static void ButcherNear(CommandArgs args)
        {
            ...
            {
                if ((Main.npc[i].active) && (distance(new Microsoft.Xna.Framework.Vector2(Main.item[i].position.X, Main.item[i].position.Y), new Point((int)Main.player[args.Player.Index].position.X, (int)Main.player[args.Player.Index].position.Y)) < nearby * 16))
                {
        ...
        public static int distance(Microsoft.Xna.Framework.Vector2 point1, Point point2)
        {
